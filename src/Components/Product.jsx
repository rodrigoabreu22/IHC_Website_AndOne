...
const Product = () => {
  ...
  const toggleShowA = () => setShowA(!showA); // Moved up here
  ...
  const favTest = (id) => {
    if (favorites.includes(id)) return 'Adicionar aos favoritos';
    else return 'Remover dos favoritos';
  };
  ...
  return (
    <div>
      ...
      <ToastContainer className="p-3" position="top-center">
        <Toast show={showA} delay={5000} autohide onClose={toggleShowA}>
          <Toast.Header>
